...
const Services = () => {
    ...
    return(
        <div className="flex flex-col bg-[#e4e4e4] text-[#565656]">
            ...
            <div className="mx-20">
                ...
                <div className="flex justify-center items-center">
                        <div className="rounded shadow-lg bg-white max-w-md h-96">
                    ...
                    <div className="flex justify-center items-center">
                        <div className="flex-col rounded shadow-lg bg-white max-w-md h-96">
