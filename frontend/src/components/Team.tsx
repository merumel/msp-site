        ...
        <div className="block bg-stone-300">
            <div className="flex flex-row divide-x-2 divide-stone-800 mx-10 py-10">
                <div className="flex flex-col w-3/5 h-48">
                    ...
                    <p className="inline-block text-xl px-28 pt-10">Native houstonians.... 15 years of collective IT experience.... Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil. </p>
                </div>
