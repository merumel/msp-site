  ...
  return (
    <Layout bodyClass={null}>
      ...
      <div className="grid grid-cols-1 items-center divide-y-0">
            ...
            <div className="container mt-10 w-full lg:w-9/12 lg:pr-6">
              ...
              >
                <div className="flex-1">
                  <div className="flex flex-row items-center space-x-3 pb-1">
                    <svg
        ...
        <div className="flex w-full items-center justify-center space-x-5 bg-gray-400 p-4 text-sm md:text-base">
          <p>Leave us a review: </p>
          <a href="https://www.yelp.com/biz/max-level-it-richmond">
            <div className="flex flex-row items-center  pb-1 hover:underline">
              <YelpLogo className="h-5 pr-2" />
              <p>Yelp</p>
            </div>
          </a>
          <a href="https://www.facebook.com/Max-Level-It-111753414779167 hover:underline">
            <div className="flex flex-row items-center pb-1 hover:underline">
              <FacebookLogo className="h-5 w-5" />
              <p className="pl-2">Facebook</p>
            </div>
          </a>
          <a href="https://g.page/r/CeL0t7UNNCSREAE ">
            <div className="flex flex-row items-center pb-1 hover:underline">
              <GoogleLogo className="h-5 pr-2" />
              <p>Google</p>
            </div>
          </a>
        </div>
        ...
        <div className="shadow-lg shadow-indigo-700/50" id="contact">
          <Contact />
        </div>
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-226941930-1">
        </script>
        <script>
