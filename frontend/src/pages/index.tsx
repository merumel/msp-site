  ...
  return (
    <Layout bodyClass={null}>
      <div className="grid grid-cols-1 items-center divide-y-0">
        <div className="mt-15 font-hairline relative flex self-start bg-slate-300 p-10 font-sans shadow-lg shadow-indigo-400/50">
          <div className="container ml-10 h-1/2 w-1/2 justify-center p-20">
            <h1 className="text-3xl leading-tight text-black md:text-5xl">
